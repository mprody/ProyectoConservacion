...
CREATE TABLE ConservationProjects ( ProjectID INT PRIMARY KEY, ProjectName VARCHAR(100), StartDate DATE, EndDate DATE, Budget DECIMAL(18, 2), FocusArea VARCHAR(100) );
